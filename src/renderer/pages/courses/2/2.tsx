...
export default function SecondCourse() {
  ...
  useEffect(() => {
    window.ipc.callFor(IPCEvents.updateStorage, 'set', 'exams.2', 'start');
    window.ipc.callFor(IPCEvents.updateStorage, 'set', 'lessons.2', 'finish');
  ...
  return (
    <section className="secondPage">
      ...
      <div className="main">
        ...
        <Controllers nextLink="/exams/2/1" prevLink="/courses/2/1" />
      </div>
    </section>
  );
}
